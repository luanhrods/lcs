    ...
    <div className="min-h-screen bg-[#121212] text-white font-sans relative overflow-hidden">
      ...
      <main className="pb-20 relative z-10">
        ...
        <section className="container mx-auto px-6 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {[
              { offset: 'md:translate-y-0', image: '/placeholder.svg?height=48&width=48' },
              { offset: 'md:translate-y-12', image: '/placeholder.svg?height=48&width=48' },
              { offset: 'md:translate-y-24', image: '/placeholder.svg?height=48&width=48' },
            ].map((item, index) => (
              <div key={index} className={`bg-[#1E1E1E] p-6 rounded-lg ${item.offset}`}>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-nunito">da YourListingExpertt</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="container mx-auto px-6 py-24">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <h2 className="text-4xl font-bold mb-8 md:mb-0 font-montserrat md:w-1/2">Transforme seu sonho <br>em realidade.</h2>
      ...
      <footer className="bg-[#1E1E1E] py-8">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center md:text-middle text-gray-400 text-xs font-nunito">
            © 2005-2024 LC Studio by Projeto Mídia.
          </div>
        </div>
      </footer>
    </div>
